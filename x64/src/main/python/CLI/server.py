...
from src.main.python.dev.modules.database.serverDB import ServerDB
from src.main.python.dev.modules.token.jwtManager import JWTManager
...
class Server:
    ...
    def _serve_file(self, conn, file_path):
        try:
            conn.setsockopt(socket.SOL_SOCKET, socket.SO_SNDBUF, 65536*2048)  # 64 KB
            conn.setsockopt(socket.SOL_SOCKET, socket.SO_RCVBUF, 65536*2048)  # 64 KB
